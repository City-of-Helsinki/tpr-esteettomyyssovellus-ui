...
export const API_FETCH_QUESTIONBLOCK_URL =
  "http://localhost:8000/api/ArBackendQuestionBlocks/?form_id=0&format=json";
export const API_FETCH_QUESTION_URL =
  "http://localhost:8000/api/ArBackendQuestions/?form_id=0&format=json";
export const API_FETCH_QUESTIONCHOICES =
  "http://localhost:8000/api/ArBackendQuestionChoice/?form_id=0&format=json";
