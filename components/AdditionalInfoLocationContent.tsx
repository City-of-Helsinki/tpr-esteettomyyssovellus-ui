    ...
    return(
        <div className={styles.maincontainer}>
            <div className={styles.controlscontainer}>
                <span>
                <QuestionRadioButtons mainLabel={i18n.t("common.generalChoose")} 
                    firstButtonLabel={i18n.t("common.map.point")}
                    secondButtonLabel= {i18n.t("common.map.line")}
                />
                </span>
                <span>
                <QuestionTextInput label={i18n.t("common.generalExplanation")} placeholder="ph syötä insert tekstiä" required/>
                </span>
            </div>
            <div className={styles.mapcontainer}>
                <Map initCenter={[60.169, 24.938]} initLocation={[60.169, 24.938]} initZoom={15} draggableMarker updateLocationHandler={handleUpdateLocation} />
            </div>
        </div>
    )
}
